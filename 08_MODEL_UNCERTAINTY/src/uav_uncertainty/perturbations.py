"""Seeded, mild image perturbations for V1 robustness analysis."""
...
class PerturbationConfig:
    """Conservative ranges for V1 input perturbations."""
...
class PerturbedImage:
    ...
    def metadata(self) -> dict[str, object]:
        """Return metadata without embedding image pixels."""
...
def apply_brightness(image: Image, gain: float, offset: float) -> Image:
    """Apply an affine intensity change without changing geometry."""
...
def apply_gaussian_noise(
    image: Image, sigma: float, rng: np.random.Generator
) -> Image:
    """Add zero-mean Gaussian sensor noise from the supplied generator."""
...
def generate_perturbations(
    ...
    """Generate seeded samples cycling through the five families."""
