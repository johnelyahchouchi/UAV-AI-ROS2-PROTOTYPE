...
WINDOW_NAME = "UAV Threat Analytics Dashboard"
...
class UAVThreatAnalyticsDashboard(Node):
    def __init__(self):
        super().__init__("uav_analytics_dashboard")
        ...
        self.get_logger().info("UAV threat analytics dashboard started.")
...
def main(args=None):
    ...
    node = UAVThreatAnalyticsDashboard()
