...
WINDOW_NAME = "UAV Target Timeline Dashboard"
...
class UAVTargetTimelineDashboard(Node):
    def __init__(self):
        super().__init__("uav_timeline_dashboard")
        ...
        self.get_logger().info("UAV target timeline dashboard started.")
...
def main(args=None):
    ...
    node = UAVTargetTimelineDashboard()
