...
- `uav_prototype_control_center.py` is the full local GUI entry point. It configures
  and launches the live tester, V1/V2 inspection, recorded-analysis dashboard, secure
  sender, and deterministic Mission Copilot from one readiness dashboard.
