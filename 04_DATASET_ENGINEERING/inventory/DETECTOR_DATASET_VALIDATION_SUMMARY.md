...
- Train: 28,258 images and 28,258 labels
...
- Train: 1,062 images and 1,062 labels
...
- Train: 21,978 images and 21,978 labels
...
All three detector datasets passed structural validation. Their portable YAML configurations are stored under:

`05_TRAINING\configs\detection\portable_configs`
